...
If you are a [senior or collegiate Iowa Rugby Union club](policies/request-a-referee#requests-from-iowa-rugby-union-senior-and-collegiate-clubs), match fees are paid automatically from your configured payment source in RefUp the evening of your event. See RefUp's <a href='https://docs.refup.io/teams/paying-with-a-credit-card' target='_blank'>help</a> for more info. There is also an <a href='https://docs.refup.io/societies/invoice-payments' target='_blank'>invoice process</a> that is available in extreme cases. At this time, no other payment forms are accepted.
