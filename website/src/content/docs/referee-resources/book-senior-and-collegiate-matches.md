...
Referees make Offers an matches. For details into that process, please see the <a href='https://docs.refup.io/officials/making-your-first-offer' target='_blank'>RefUp help doc</a>.

<a href='https://docs.refup.io/officials/getting-paid' target='_blank'>Payments</a> will be sent electronically to your configured Payment Destination. Expect to be paid within 10-14 days after the event.

Before 24 hours after an event, please fill out the Match Report on RefUp.

Please check the <a href='https://docs.refup.io/' target='_blank'>RefUp help docs</a> for more details and information.
