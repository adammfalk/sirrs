...
Due to the sprawl and complexity of the Tackle and Ruck laws and their application, a challenge is getting focused on what matters in a given situation. If we map likely offences to the tackle categories above, it can lessen our mental load by filtering out infringements that are not applicable to the tackle type.
